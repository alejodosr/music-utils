...
import torch
from video_utils.face_changers.dual_style_gan2.util import save_image, load_image, visualize
import argparse
...
from video_utils.face_changers.dual_style_gan2.model.dualstylegan import DualStyleGAN
from video_utils.face_changers.dual_style_gan2.model.sampler.icp import ICPTrainer
from video_utils.face_changers.dual_style_gan2.model.encoder.psp import pSp
...
class DualStyleGan2FaceChanger:
    def __init__(self, download=True, style=0):
        ...
        self.MODEL_DIR = 'video_utils/checkpoint'
        self.DATA_DIR = 'video_utils/face_changers/dual_style_gan2/data'
